...
graph$add_observations(
  data = data.frame(
    ...
    road_type7 = road_types_graph_data_dummy$FRC7,
    intensity = data_on_graph$TrafficIntensity,
    dist_mosque = data_on_graph$exp_decay_distance_to_mosque,
    dist_education = data_on_graph$exp_decay_distance_to_education,
    dist_finance = data_on_graph$exp_decay_distance_to_finance,
    dist_hospital = data_on_graph$exp_decay_distance_to_hospital,
    dist_intersection = data_on_graph$exp_decay_distance_to_intersection,
    double_dist_mosque = data_on_graph$exp_decay_double_distance_to_mosque,
    double_dist_education = data_on_graph$exp_decay_double_distance_to_education,
    double_dist_finance = data_on_graph$exp_decay_double_distance_to_finance,
    double_dist_hospital = data_on_graph$exp_decay_double_distance_to_hospital,
    double_dist_intersection = data_on_graph$exp_decay_double_distance_to_intersection,
    invsqrt_dist_mosque = data_on_graph$inv_sqrt_distance_to_mosque,
    invsqrt_dist_education = data_on_graph$inv_sqrt_distance_to_education,
    invsqrt_dist_finance = data_on_graph$inv_sqrt_distance_to_finance,
    invsqrt_dist_hospital = data_on_graph$inv_sqrt_distance_to_hospital,
    invsqrt_dist_intersection = data_on_graph$inv_sqrt_distance_to_intersection,
...
graph$add_observations(
  data = data.frame(
    ...
    road_type7 = road_types_graph_mesh_dummy$FRC7,                                      
    ...
    double_dist_mosque = data_on_mesh$exp_decay_double_distance_to_mosque,
    double_dist_education = data_on_mesh$exp_decay_double_distance_to_education,
    double_dist_finance = data_on_mesh$exp_decay_double_distance_to_finance,
    double_dist_hospital = data_on_mesh$exp_decay_double_distance_to_hospital,
    double_dist_intersection = data_on_mesh$exp_decay_double_distance_to_intersection,
...
data_spde2 <- graph_data_spde(graph_spde = spde_model2, name = "field",
                              covariates = c("Intercept", "length", "speed_limit", 
                                             "road_type1", "road_type2", "road_type3", "road_type4", "road_type5", "road_type6",
                                             "intensity", "dist_mosque", "dist_education", "dist_finance", "dist_hospital", "dist_intersection",
                                             "double_dist_mosque", "double_dist_education", "double_dist_finance", "double_dist_hospital", 
                                             "double_dist_intersection", "invsqrt_dist_mosque", "invsqrt_dist_education","invsqrt_dist_finance",
                                             "invsqrt_dist_hospital", "invsqrt_dist_intersection")
                              )
```
...
stk2 <- inla.stack(
  data = data_spde2[["data"]],
  A = data_spde2[["basis"]],
  effects = data_spde2[["index"]],
  tag = "data"
)
